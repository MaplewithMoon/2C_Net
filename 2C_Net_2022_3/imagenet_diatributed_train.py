...
def main_worker(gpu, ngpus_per_node, args):
    ...
    pretrained_net = torch.load('/home/2C_Net/model/deepcoder_lam=500_beta=0.2_mse_c128-128_epoch1_step_12_bpp_0.6363_MSE_0.0013.pkl')
    #pretrained_dict = torch.load('./model/reducepool_2c_fixed_mid_epoch_2_acc_31.522_state_dict.pth')
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        torch.save(model.state_dict(),'./model/reducepool_2c_fixed_0.6_epoch_'+ str(epoch) + '_acc_' + str(acc1.data.cpu().numpy())+'_state_dict' +'.pth')
...
def train(train_loader, model, criterion, criterion_rec, optimizer, epoch, args):
    ...
    progress = ProgressMeter(
        len(train_loader),
        [batch_time, data_time, losses_cls, top1],
